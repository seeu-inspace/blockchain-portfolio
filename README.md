...
### <ins>Oracle manipulation</ins>

A vulnerability emerges when protocols that rely on oracles carry out actions automatically even when the oracle provides erroneous data, and the results can be severe.
